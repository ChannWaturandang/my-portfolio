<header class="lg:w-1/5">
    <div class="sticky top-0 z-10 flex flex-col transition-all duration-300 lg:py-8">
        <div
            ...
            <div class="flex items-start justify-between md:px-2 lg:flex-col lg:space-y-4">
                <div class="flex w-full flex-grow items-center gap-4 lg:flex-col lg:items-start lg:gap-0.5">
                    <div
                        class="overflow-hidden rounded-full border-2 border-neutral-400 dark:border-neutral-600 duration-700 ease-in-out scale-80 blur-0 grayscale-0 lg:hover:scale-110 w-32 h-32">
                        <img alt="Chan Waturandang" fetchpriority="high" decoding="async"
                            class="w-full h-full rounded-full object-cover" src="{{ asset('images/profile1.jpeg') }}">
                    </div>

                    <div class="mt-1 flex items-center gap-2 lg:mt-4"><a href="/">
                            <h2 class="flex-grow text-lg font-medium lg:text-md">Chan Waturandang</h2>
                        </a>
                        <div class="relative inline-block">
                            <div class="tooltip-container relative"><svg stroke="currentColor" fill="currentColor"
                                    stroke-width="0" viewBox="0 0 24 24" class="text-blue-400" height="18"
                    ...
                    <div
                        class="hidden text-sm cursor-pointer text-neutral-600 transition-all duration-300 hover:text-neutral-700 dark:text-neutral-500 dark:hover:text-neutral-400 lg:flex">
                        <a href="https://www.instagram.com/chn.w__/"
                            class="decoration-none hover:text-blue-500 hover:text[15px]">@chn.w__</a>
                    </div>
                    ...
                    <div class="hidden w-full items-center justify-between lg:mt-2 lg:flex gap-2">
                        ...
                        <a href="mailto:chanwaturandang22@gmail.com"
                            ...
                            <!-- Ledakan hijau -->
                            <div
                                class="absolute left-4 top-1/2 z-0 h-2 w-2 -translate-y-1/3 rounded-full bg-green-400 transition-all duration-700 ease-out group-hover:h-[200%] group-hover:w-[600%] group-hover:left-0 group-hover:top-0 group-hover:rounded-none">
                            </div>
                        </a>

                        <div class="flex gap-4">
                            <button
                                class="flex items-center justify-center text-neutral-900 dark:text-neutral-300 "><select
                                    class="inline-flex appearance-none rounded-xl bg-neutral-100 px-2 py-1 outline-none transition duration-300 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700">
        ...
        <div class="hidden md:block">
            <div class="my-4 border-t border-neutral-300 dark:border-neutral-700"></div>
                ...
                <nav class="flex flex-col gap-y-1"><a aria-current="page" target="" href="/">
                        ...
                        <a href="{{ route('achievements.index') }}">
                            <div
                                ...
                                <div class="flex-grow">Achievements</div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                        ...
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M132,20A104.11,104.11,0,0,0,28,124v84.33A19.69,19.69,0,0,0,47.67,228H132a104,104,0,0,0,0-208Zm0,184H52V124a80,80,0,1,1,80,80Zm-8-76a16,16,0,1,1-16-16A16,16,0,0,1,124,128Zm48,0a16,16,0,1,1-16-16A16,16,0,0,1,172,128Z">
                                        </path>
                                    </svg>
                                </div>

                                <div class="flex-grow">Chat Room</div>
                        ...
                        <a target="" href="/contact">
                            <div
                                ...
                                <div class="flex-grow">Contact</div>
            ...
            <div
                class="font-sora flex flex-wrap items-center justify-center gap-1 text-sm text-neutral-600 dark:text-neutral-400">
                <p>COPYRIGHT © </p><span>2025</span>
                <p>Chan Waturandang. All rights reserved.</p>
            </div>
        </div>
    </div>
</header>
