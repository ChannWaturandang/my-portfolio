...
@section('contents-admin')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white dark:text-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
        ...
        <div
            class="bg-white dark:text-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg transform hover:scale-105 hover:cursor-pointer transition-all duration-300 animate-fade-in-up delay-300">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center animate-fade-in-up mt-3">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
            <h2 class="text-2xl font-semibold mb-4 text-black dark:text-white"><i class="fa fa-chart-pie mr-2"></i>Visitors
            </h2>
            <div class="flex items-center justify-center">
                <svg class="w-40 h-40">
                    ...
                    <circle class="text-red-500 dark:text-cyan-400 progress-ring" stroke-width="10" stroke-linecap="round"
                        stroke="currentColor" fill="transparent" r="70" cx="80" cy="80" stroke-dasharray="440"
