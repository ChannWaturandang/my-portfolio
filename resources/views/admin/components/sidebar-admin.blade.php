        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('admin') }}"
                    ...
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M20.488 9H15V3.512A8.978 8.978 0 0120.488 9z" />
                    </svg>
            ...
            <li>
                <a href="{{ route('admin.achievements') }}"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <!-- Icon: Star (Achievements) -->
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.528 4.674a1 1 0 00.95.69h4.911c.969 0 1.371 1.24.588 1.81l-3.977 2.89a1 1 0 00-.364 1.118l1.528 4.674c.3.921-.755 1.688-1.54 1.118l-3.977-2.89a1 1 0 00-1.176 0l-3.977 2.89c-.784.57-1.838-.197-1.539-1.118l1.528-4.674a1 1 0 00-.364-1.118L2.98 10.101c-.782-.57-.38-1.81.588-1.81h4.91a1 1 0 00.951-.69l1.528-4.674z" />
                    </svg>
            ...
            <li>
                <a href="{{ route('admin.dashboard') }}"
                    ...
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 10l9-7 9 7v8a2 2 0 01-2 2h-4a2 2 0 01-2-2V13a2 2 0 00-2-2H5a2 2 0 00-2 2v5a2 2 0 002 2h4a2 2 0 002-2v-3" />
                    </svg>
            ...
            {{-- <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">About</span>
