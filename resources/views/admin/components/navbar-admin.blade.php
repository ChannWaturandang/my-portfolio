    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                <img src="{{ asset('/images/logo.png') }}" class="mr-3 h-8" alt="Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">chan</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button @click="toggleDarkMode"
                class="px-3 py-2 rounded-full text-dark dark:text-white shadow transition"
