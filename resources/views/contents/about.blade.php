...
@section('content')
    <div class="mt-20 p-8 lg:mt-0 aos-init aos-animate" data-aos="fade-up">
            ...
            <div class="space-y-2">
                ...
                <div
                    ...
                    <div class="mt-2 flex flex-col gap-4 md:mt-0 md:flex-row"><a target="_blank"
                            ...
                            </svg><span>Download Portfolio</span></a><a target="_blank"
                            class="group flex w-fit items-center gap-2 rounded-lg border border-neutral-400 bg-neutral-100  px-3 py-2 text-sm transition duration-100 hover:text-neutral-800 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:text-neutral-200"
                            href="https://bit.ly/cv-satriabahari"><svg stroke="currentColor" fill="none" stroke-width="2"
                                ...
                                <polyline points="7 10 12 15 17 10"></polyline>
                                <line x1="12" x2="12" y1="15" y2="3"></line>
                            </svg><span>Download Resume</span></a></div>
                </div>
            </div>
        ...
        from-neutral-200 to-neutral-100 transition-all duration-300 hover:to-[#ffffff] dark:from-[#242424] dark:to-neutral-900 dark:hover:to-neutral-950 flex items-center gap-5 px-6 py-4 ">
                        <img alt="Universitas Jambi" loading="lazy" width="70" height="70" decoding="async"
                            data-nimg="1"
                            srcset="/_next/image?url=%2Fimages%2Feducation%2Funja.png&amp;w=96&amp;q=75 1x, /_next/image?url=%2Fimages%2Feducation%2Funja.png&amp;w=256&amp;q=75 2x"
                            src="/_next/image?url=%2Fimages%2Feducation%2Funja.png&amp;w=256&amp;q=75"
                            style="color: transparent;">
                        <div class="space-y-1"><a href="https://www.unja.ac.id" target="_blank">
                                <h6>Jambi University</h6>
                            </a>
                            <div class="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
                                <div class="flex flex-col gap-1 md:flex-row md:gap-2"><span>Bachelor's degree</span><span
                                        class="hidden text-neutral-300 dark:text-neutral-700 md:block">•</span><span>Information
                                        Systems, (S.Kom)</span></div>
                                <div class="flex flex-col gap-1 text-[12px] md:flex-row md:gap-2"><span
                                        class="dark:text-neutral-500">2022 - 2026</span><span
                                        class="hidden rounded-full text-neutral-300 dark:text-neutral-700 md:block">•</span><span>Jambi,
                                        Indonesia 🇮🇩</span></div>
                            </div>
                        </div>
                    </div>
